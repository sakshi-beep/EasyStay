          ...
          <div class="col-lg-6">
            ...
            <div class="col-lg-6">
              <div class="info-box card">
                ...
                <h3>Address</h3>
                <p>Mass Comm stage, South B<br>Nairobi, Kenya</p>
              </div>
            </div>
            <div class="col-lg-6">
              <div class="info-box card">
          ...
          <div class="card p-4">
            <form action="forms/contact.php" method="post" class="php-email-form">
              <div class="row gy-4">
                ...
                <div class="col-md-6">
                  <input type="text" name="name" class="form-control" placeholder="Your Name" required value="<?=$reg[1]?>" readonly>
                </div>

                <div class="col-md-6 ">
                  <input type="email" class="form-control" name="email" placeholder="Your Email" required value="<?=$reg[5]?>" readonly>
                </div>
