          ...
          <form method="POST" id="booking_form">
            ...
            <div class="row">
              ...
              <div class="col-12">
                ...
                <button type="button" onclick="payNow()" class="btn w-100 text-white custom-bg shadow-none mb-1" id="pay_now_btn" >Pay Now</button>
              </div>
            </div>
          </form>
        </div>
...
<script>
  ...
  function payNow() {
    ...
    let checkoutValue = booking_form.elements['checkout'].value;

    let paymentText = document.getElementById('pay_info').innerText;
    console.log({ paymentText})
    let paymentAmount = parseInt(paymentText.match(/₹(\d+)/)[1]);
