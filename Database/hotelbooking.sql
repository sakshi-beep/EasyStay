...
-- Dumping data for table hostelbooking.admin_cred: ~2 rows (approximately)
INSERT INTO `admin_cred` (`sr_no`, `admin_name`, `admin_pass`) VALUES
	(1, 'sakshi', '12345');

-- Dumping data for table hostelbooking.booking_details: ~20 rows (approximately)
...
-- Dumping data for table hostelbooking.booking_order: ~20 rows (approximately)
...
-- Dumping data for table hostelbooking.carousel: ~5 rows (approximately)
...
-- Dumping data for table hostelbooking.rating_review: ~7 rows (approximately)
...
-- Dumping data for table hostelbooking.user_cred: ~5 rows (approximately)
