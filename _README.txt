...
[.] define('SITE_URL','http://127.0.0.1/hostelbooking/')
  
  -> change the above url accordingly, if your project folder name is changed from "hostelbooking" to something else.

[.] define('UPLOAD_IMAGE_PATH',$_SERVER['DOCUMENT_ROOT'].'/hostelbooking/images/')

  -> change the above url accordingly, if your folder name is changed from "hostelbooking" to something else.
...
3. hostelbooking/inc/paytm/config_paytm.php
...
[.] Change the below constant with callback url accrodingly -> but dont change the file pay_resonse.php
	...
	define('CALLBACK_URL', 'http://localhost/hostelbooking/pay_response.php'); 
