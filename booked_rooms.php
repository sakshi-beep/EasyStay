...
<head>
  ...
  <title>Tables / Booked Room</title>
 ...
 <script src="https://cdn.jsdelivr.net/npm/sweetalert2@11"></script>
    ...
    <script>
  // Function to confirm room deletion with SweetAlert
  function ConfirmDelete(id) {
    Swal.fire({
      title: 'Are you sure?',
      text: 'You will not be able to recover this room data!',
      icon: 'warning',
      ...
      if (result.isConfirmed) {
        // If user confirms, redirect to delete_room.php with room ID
    ...
    <ul class="sidebar-nav" id="sidebar-nav">
      ...
      <li class="nav-item">
        ...
        <ul id="tables-nav" class="nav-content collapse show" data-bs-parent="#sidebar-nav">
          <li>
            <a href="booked_rooms.php" class="active">
          ...
          <div class="card">
            <div class="card-body">
              ...
              if($is_admin){
                ...
                $test = "SELECT * FROM `rooms` WHERE email='$femail'";
                }
              ...
              <table class="table datatable">
                ...
                <tbody>
                  <?php
                  while($room = mysqli_fetch_array($res)){
                  ?>
                  <tr>
                    <td><?=$room[1]?></td>
                    <td><?=$room[3]?></td>
