        ...
        <ul id="tables-nav" class="nav-content collapse " data-bs-parent="#sidebar-nav">
          ...
          <li>
            <a href="user_details.php">
              <i class="bi bi-circle"></i><span>Users Detals</span>
            </a>
          </li>
        </ul>
      </li><!-- End Tables Nav -->
      ...
      <div class="row">
          ...
          <div class="row">
            ...
            <div class="col-12">
              <div class="card">
                ...
                <div class="card-body">
                  <h5 class="card-title">Class Activities <span>/Today</span></h5>
                  ...
                  <script>
                    document.addEventListener("DOMContentLoaded", () => {
                      new ApexCharts(document.querySelector("#reportsChart"), {
                        ...
                        xaxis: {
                          type: 'date',
                          categories: ["Jan", "March", "May", "July", "Sep", "Nov", "Dec"]
                        },
                        tooltip: {
                          x: {
                            format: 'date'
        ...
        <div class="col-lg-4">
          ...
          <div class="card">
            ...
            <div class="card-body">
              <h5 class="card-title">School Activites <span>| Today</span></h5>
              ...
              <div class="activity">
                ...
                <div class="activity-item d-flex">
                  <div class="activite-label">APRIL</div>
                ...
                <div class="activity-item d-flex">
                  <div class="activite-label">SEP</div>
          ...
          <div class="card">
            ...
            <div class="card-body pb-0">
              <h5 class="card-title">Student's Activities<span>| Today</span></h5>
